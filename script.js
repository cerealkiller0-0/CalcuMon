...
compute(){
    let computation
    const prev = parseFloa(this.previousOperand)
...
updateDisplay(){
    this.currentOperandTextElements.innerText = this.getDisplayNumber(this.currentOperand)
    if(this.operation!=null){
        this.previousOperandTextElements.innerText = `${this.getDisplayNumber(this.previousOperand)} ${this.operation}`  
    }else{
...
const previousOperandTextElements = document.querySelectorAll('[data-previous-operand]')
const currentOperandTextElements = document.querySelectorAll('[data-current-operand]')
